...
- [`@kuralle-agents/livekit-plugin-transport-ws`](../kuralle-livekit-plugin-transport-ws) — implements this protocol on the WebSocket path
- [`@kuralle-agents/realtime-audio`](../kuralle-realtime-audio) — provider-native realtime sessions
