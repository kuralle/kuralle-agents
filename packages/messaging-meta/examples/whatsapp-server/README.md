...
```bash
bun run packages/messaging-meta/examples/whatsapp-server/server.ts
# or: npx tsx packages/messaging-meta/examples/whatsapp-server/server.ts
```
...
```bash
bun test packages/messaging-meta/examples/whatsapp-server/whatsapp-server.test.ts
```
