...
- [`@kuralle-agents/livekit-plugin-transport-sip`](../kuralle-livekit-plugin-transport-sip) — SIP/RTP alternative
- [`@kuralle-agents/livekit-plugin-transport-ws`](../kuralle-livekit-plugin-transport-ws) — generic WebSocket transport
