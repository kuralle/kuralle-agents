...
- [`@kuralle-agents/livekit-plugin-transport-ws`](../kuralle-livekit-plugin-transport-ws) — WebSocket server used above
- [`@kuralle-agents/livekit-plugin-transport-http`](../kuralle-livekit-plugin-transport-http) — HTTP/SSE transport alternative
- [`@kuralle-agents/realtime-audio`](../kuralle-realtime-audio) — provider-native realtime (Gemini Live, OpenAI Realtime)
