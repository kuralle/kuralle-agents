 ...
 * Run: bun run packages/e2e-tests/tests/postcall-audit/05-eval-replay-and-score.ts
 */
...
const fixture = fileURLToPath(
  new URL('../../../eval/fixtures/golden/quickstart_favorite_color_path.jsonl', import.meta.url),
);
const manifest = fileURLToPath(new URL('../../../eval/fixtures/golden.manifest.json', import.meta.url));
