...
| Provider | [`CloudflareGeminiLiveClient`](../../../kuralle-realtime-audio/src/cloudflare/gemini-live.ts) — Gemini Live provider |
| Wire protocol | [`@kuralle-agents/voice-protocol`](../../../kuralle-voice-protocol/) — browser/worker voice protocol |
