...
const STORAGE_KEY = "kuralle-cf-voice-gemini-user-id";
  ...
  return (
    <div style={styles.page}>
      <header style={styles.header}>
        <h1 style={styles.title}>Kuralle Realtime Voice</h1>
        <p style={styles.subtitle}>
          Wave 3 smoke — Gemini 3.1 Flash Live Preview on Cloudflare Workers.
        </p>
      </header>
