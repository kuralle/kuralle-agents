...
const DEPRECATION_NOTICE = [
  ...
  '  npx tsx packages/kuralle-e2e-tests/tests/sip-realtime-authority-e2e.ts',
  '  npx tsx packages/kuralle-e2e-tests/tests/agentsession-e2e.ts',
  '  npx tsx packages/kuralle-e2e-tests/tests/agentsession-tools-e2e.ts',
  '  npx tsx packages/kuralle-e2e-tests/tests/agentsession-flow-e2e.ts',
  '',
