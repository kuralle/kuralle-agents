 ...
 *   npx tsx packages/kuralle-e2e-tests/tests/voice-load-test.ts wss://kuralle-voice-agent.fly.dev
 *
 *   # Against local server
 *   npx tsx packages/kuralle-e2e-tests/tests/voice-load-test.ts ws://127.0.0.1:3000
 *
 *   # With custom max concurrency
 *   MAX_CONCURRENCY=30 npx tsx packages/kuralle-e2e-tests/tests/voice-load-test.ts wss://kuralle-voice-agent.fly.dev
 *
