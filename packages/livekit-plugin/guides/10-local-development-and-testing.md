...
```bash
bun test packages/livekit-plugin-transport-twilio/test
```
...
```bash
bun test packages/livekit-plugin-transport-sip/test
```
...
```bash
bun test packages/livekit-plugin-transport-smartpbx/test
```
