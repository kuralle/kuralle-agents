...
- [`@kuralle-agents/livekit-plugin`](../livekit-plugin) — cascaded STT → LLM → TTS voice path via LiveKit
- [`@kuralle-agents/livekit-plugin-transport-ws`](../livekit-plugin-transport-ws) — WebSocket transport for audio connections
