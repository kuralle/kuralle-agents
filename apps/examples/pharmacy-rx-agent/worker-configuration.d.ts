/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 8e06bf30342212146165fbcfc360818f)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_URL: "https://kuralle-pharmacy-workspace-agent.mithushancj.workers.dev";
	MODEL_ID: "gpt-4.1-mini";
	PharmacyAgent: DurableObjectNamespace<import("./cloudflare/worker").PharmacyAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/worker");
		durableNamespaces: "PharmacyAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "MODEL_ID">> {}
}
