...
House-neutral rules for making prose read like a person wrote it, and for judging whether it does. They apply to any surface: a social post, a content page, a thread, release notes. Platform- or brand-specific voice guidance layers on top of them.
