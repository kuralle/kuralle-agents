...
| Driver | Command |
| --- | --- |
| Pi — the default | `bun run --filter @kuralle-examples/hotel-receptionist chat` |
| Core's built-in AI SDK driver | `bun run --filter @kuralle-examples/hotel-receptionist chat:ai-sdk` |
