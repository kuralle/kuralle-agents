...
import aiSdkTelemetryExample from '../../../examples/observability/ai-sdk-telemetry.ts?raw';
...
<Code code={aiSdkTelemetryExample} lang="typescript" title="ai-sdk-telemetry.ts" />
