...
When a conversation can go to multiple specialists, you need a router. Kuralle `routes` + `routing` setup handles the decision and the handoff without surfacing triage logic to the user.
